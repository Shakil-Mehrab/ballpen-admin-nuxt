<template>
  <aside
    class="relative flex-shrink-0 hidden h-[93vh] bg-white border-r border-gray-200 xl:order-first xl:flex xl:flex-col w-96"
  >
    <div class="px-6 pt-6 pb-4">
      ...
      <h2 class="mt-2 text-lg font-medium text-gray-900">Directory</h2>
...
export default {
  ...
  methods: {
    async search(keyword) {
      console.log(keyword)
      this.$emit('searchActionFromAside', keyword)
    },
